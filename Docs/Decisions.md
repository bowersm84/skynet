...
### D-INV-02 — Low-stock threshold raised to 5 bars (2026-08-05)
Raw Material Inventory low-stock threshold raised from <2 to <=5 available bars (LOW_STOCK_BAR_THRESHOLD constant in Armory.jsx), per purchasing. Out (0) and negative styling unchanged. Effect on PROD at the time of the change: amber lots go from 2 to 22 of 178, alongside 13 out-of-stock and 6 negative.
